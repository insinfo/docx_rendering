...
class Delta {
  ...
  bool operator ==(Object other) {
    ...
    if (operations.length != typedOther.operations.length) return false;
    for (var i = 0; i < operations.length; i++) {
      if (operations[i] != typedOther.operations[i]) return false;
    }
    return true;
  }
  ...
  Delta diff(Delta other, {bool cleanupSemantic = true}) {
    ...
    bool isEqual(Object? a, Object? b) => deepEquals(a, b, unordered: true);
